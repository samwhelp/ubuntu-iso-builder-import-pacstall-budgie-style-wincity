...
> [ubuntu-iso-builder-import-pacstall-budgie-style-wincity](https://samwhelp.github.io/ubuntu-iso-builder-import-pacstall-budgie-style-wincity/)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-style-wincity/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-style-wincity/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-style-wincity/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-budgie-style-wincity](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-style-wincity)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-style-wincity.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-budgie-style-wincity`

``` sh
cd ubuntu-iso-builder-import-pacstall-budgie-style-wincity
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-budgie-style-wincity/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-style-wincity/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-budgie-style-wincity/iso-profile/dist`
